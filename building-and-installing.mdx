---
title: "Build and Install libLWXGL.so from Source on Linux"
sidebarTitle: "Installation"
description: "Compile libLWXGL.so from source using g++ and the provided Makefile, then install the shared library and header to /usr/local with sudo."
---
