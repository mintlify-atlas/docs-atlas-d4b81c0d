...
description: "Reference for LWXGL drawing primitives — GPrimitiveRect, GPrimitiveCircle, GPrimitiveLine, GPrimitiveSprite — that render into image element pixel buffers."
---
