---
title: "Get Started with LWXGL in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Open an X11 window with LWXGL, add a button and a text label, and run a fixed-FPS loop — all in under 30 lines of C."
---
