---
title: "LWXGL Color Palette: 16-Color System and Runtime Editing"
...
Several element types — Button, Input, and Checkbox — have both a **border/outline** color and a **fill/background** color. Rather than taking two separate color parameters, these elements accept a single packed byte where each nibble holds one palette index.
